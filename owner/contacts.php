		...
		<div class="col s12">
			<div class="row">
											...
											<tr>
												<td>
													...
													<p class="responsive-text" style="font-size:100%;">
														<span class="primary" title="Email">
															<a href="mailto:nvaishampayan@ucmerced.edu">nvaishampayan@ucmerced.edu</a>
														</span>
														<span class="defaultText">&bull;</span>
														<span class="primary" title="Phone Number">
															<a href="tel:1-510-570-5088" style="white-space: nowrap">
																<i class="fa fa-phone" aria-hidden="true"></i> 510-570-5088</a>
														</span>
													</p>
												</td>
											</tr>
				...
				<div id="tenants" class="col s12">
					...
					ALl the tenants go here

				</div>
				<div id="vendors" class="col s12">

					All the vendors will be here
